...
namespace LearnCourses.Service
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePayment(HttpContext context, TransactionsHistory model)
        {
            ...
            vnpay.AddRequestData("vnp_OrderInfo", "Thanh toan don hang:" + model.CourseId);
            vnpay.AddRequestData("vnp_OrderType", "other"); //default value: other
            vnpay.AddRequestData("vnp_ReturnUrl", _config["Vnpay:Vnp_ReturnUrl"]);
            vnpay.AddRequestData("vnp_TxnRef", $"{model.CourseId}_{tick}"); // Mã tham chiếu của giao dịch tại hệ thống của merchant. Mã này là duy nhất dùng để phân biệt các đơn hàng gửi sang VNPAY. Không được trùng lặp trong ngày
